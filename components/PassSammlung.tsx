            ...
            {sammlung.gefahren.map((pass) => (
              <li key={pass.id}>
                <Link
                  ...
                  className="group -mx-2 flex items-center justify-between gap-3 rounded-md px-2 py-3 transition-colors duration-fast hover:bg-surface druckbar focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-accent/40"
                >
          ...
          <ul className="flex flex-col divide-y divide-border border-y border-border">
            {sammlung.offen.map((pass) => (
              <li key={pass.id}>
                <Link
                  href={`/paesse#${pass.id}`}
                  className="-mx-2 flex min-h-11 items-center justify-between gap-3 rounded-md px-2 py-2 text-muted transition-colors duration-fast hover:bg-surface druckbar hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-accent/40"
                >
                  <span className="flex min-w-0 items-baseline gap-2">
